		...
		>
			<div className="max-w-(--layout-content-width) mx-auto px-4 sm:px-6 w-full pt-24 pb-32">
				<div className="typeset typeset-docs">
					...
					>
						Your Next.js application has been successfully configured with the
						@inklu/docs package. You have full access to beautiful layouts, page
						transitions, and micro-interactions like this{" "}
						<HoverCard>
							<HoverCardTrigger
								render={
							...
							>
								<div className="flex justify-between space-x-4">
									<div className="space-y-1">
										<h4 className="text-sm font-semibold">@inklu/docs</h4>
										<p className="text-sm">
											Polished documentation primitives for Next.js
										</p>
									</div>
								</div>
							</HoverCardContent>
...
function TourStartButton() {
	const { startTour } = require("@/components/tour-provider").useTour();
	return (
		<button
